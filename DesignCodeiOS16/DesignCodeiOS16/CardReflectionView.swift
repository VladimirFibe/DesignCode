    ...
    var body: some View {
        ZStack {
            ...
            Image("Background 1")
                ...
                .overlay(LinearGradient(colors: [.clear, .white.opacity(0.5), .clear], startPoint: .topLeading, endPoint: .bottomTrailing))                .overlay(RoundedRectangle(cornerRadius: 50)
                ...
                .overlay(
                    LinearGradient(
                        colors: [Color(#colorLiteral(red: 0.3647058904, green: 0.06666667014, blue: 0.9686274529, alpha: 0.5)), Color(#colorLiteral(red: 0.2196078431, green: 0.007843137255, blue: 0.8549019608, alpha: 0.5))],
